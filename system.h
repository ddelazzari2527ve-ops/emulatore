...
// ── PORTATA PERDITA ACCIDENTALE ───────────────────────────────────────────────
// Usata SOLO dal comando PERDITA (infiltrazione lenta, valvola guasta).
// Portata piccola fissa: τ = 15/(0.5/60) ≈ 1800 s → deriva lenta verso T_rete.
// NON usare per raffreddamento normale o iniezione: usa p_portata_valvola.
